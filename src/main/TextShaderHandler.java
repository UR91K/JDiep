...
public class TextShaderHandler {
    private int shaderProgram;
    private GLFWErrorCallback errorCallback;

    public TextShaderHandler() {
        this.shaderProgram = createShaderProgram();
        if (this.shaderProgram == 0) {
            throw new RuntimeException("Failed to create text shader program");
        }
        printActiveUniforms();
    }
    ...
    private int createShaderProgram() {
        int vertexShader = compileShader(GL_VERTEX_SHADER, "text_vertex.glsl");
        int fragmentShader = compileShader(GL_FRAGMENT_SHADER, "text_fragment.glsl");
    ...
    private int compileShader(int type, String fileName) {
        ...
        System.out.println("Text shader source for " + fileName + ":");
    ...
    private boolean checkShaderLinkErrors(int program) {
        ...
        if (success.get(0) == GL_FALSE) {
            ...
            System.err.println("Text shader program linking failed:");
            System.err.println(infoLog);
            return false;
        }
        return true;
    ...
    public void printActiveUniforms() {
        ...
        for (int i = 0; i < uniformCount; i++) {
            ...
            System.out.println("Text Uniform " + i + " Type: " + type.get(0) +
    ...
    public void setUniform(String name, Matrix4f value) {
        ...
        if (location != -1) {
            ...
            System.err.println("Warning: uniform '" + name + "' not found in text shader program.");
        }
    }
